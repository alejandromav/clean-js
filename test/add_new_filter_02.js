...
import { setFilterOption } from '../src/add_new_filter__02';
...
describe('Test setFilterOption with stub filter options', () => {
    it('should add the stub option as selected when none option is yet selected', () => {
        stubFilterOption['isDefault'] = false;

        stubFilter = setFilterOption(stubFilter, stubParentFilter, stubFilterOption);
...
describe('Test setFilterOption with date filter options', () => {
...
describe('Test setFilterOption with multi selection filter', () => {
    beforeEach(() => {
    ...
    it('should add a second selected option', () => {
        ...
        stubFilter = setFilterOption(stubFilter, stubParentFilter, stubFilterOption);
        stubFilter = setFilterOption(stubFilter, stubParentFilter, anotherStubFilterOption);
